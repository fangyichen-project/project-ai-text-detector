...
```mermaid
  flowchart TD
    ...
    J-->|Random Forest|K[Prediction Rate using RF]  //On Working, needs to clean the spaghetti codes.
    J-->|Support Vector Machine|L[Prediction Rate using svm]
    I-->|Word Embedding|M[Prediction Rate using word embedding] //On working
```
